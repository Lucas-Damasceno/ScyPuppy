...
LangString olderOrUnknownVersionInstalled ${LANG_ENGLISH} "An $R4 version of ${PRODUCTNAME} is installed. Uninstall it before continuing with this installation."
LangString silentDowngrades ${LANG_ENGLISH} "Downgrades are disabled for the silent installer. Use the graphical installer instead.$\n"
...
LangString deleteAppData ${LANG_ENGLISH} "Delete all ScryPuppy data, settings, and saved credentials"
