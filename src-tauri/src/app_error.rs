...
impl AppError {
    ...
    pub fn from_legacy(message: impl Into<String>) -> Self {
        ...
        let exact_code = match message.as_str() {
            ...
            "A Base de Conhecimento aceita texto ou imagens selecionadas. Selecione algum conteúdo antes de usar o atalho." => Some("capture.reference_requires_text"),
            "The Knowledge Base accepts selected text or images. Select content before using the shortcut." => Some("capture.reference_requires_text"),
