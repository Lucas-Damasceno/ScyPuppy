...
const messageTemplates: Record<string, string> = {
  ...
  "capture.reference_requires_text": "The Knowledge Base accepts selected text or images. Select content before using the shortcut.",
  ...
  "retention.invalid_policy": "Choose a valid history retention period.",
  "retention.invalid_existing_action": "Choose whether to keep or delete existing history.",
  "retention.selection_changed": "Your history changed. Review the updated retention preview before continuing.",
  ...
  "document.scope_empty": "Select at least one source with available items.",
  ...
  "ai.key_required": "Configure an AI provider key in Settings before creating a document.",
  "ai.provider_failed": "The AI provider could not create the document. Your filters were preserved; try again.",
...
const legacyExactCodes: Record<string, string> = {
  ...
  "A Base de Conhecimento aceita texto ou imagens selecionadas. Selecione algum conteúdo antes de usar o atalho.": "capture.reference_requires_text",
  "The Knowledge Base accepts selected text or images. Select content before using the shortcut.": "capture.reference_requires_text",
